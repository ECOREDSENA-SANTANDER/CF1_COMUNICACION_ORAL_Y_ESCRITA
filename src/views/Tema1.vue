  ...
  .curso-main-container.pb-3
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
        .col-lg-6.col-md-10
          img.mb-3(src='@/assets/curso/Tema1/img01.png', alt='')
        .col.lg-6 
      ...
      #t_1_1.titulo-segundo.mb-5
        h2 1.1  Naturaleza de la comunicación 
      ...
      #t_1_2.titulo-segundo.mb-5
        h2 1.2  Procesos de la comunicación

      .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
        .col-lg-5.col-11.col-md-6
          img.mb-3(src='@/assets/curso/Tema1/img03.png', alt='')
        .col-lg-1.col-3.col-md-2
          img.mb-3(src='@/assets/curso/Tema1/img04.png', alt='')
        .col-lg-6
        ...
        .col-lg-12
          .fondo1.p-4
            .row.justify-content-center.align-items-center.mb-1
              .col-lg-11
                SlyderA(tipo="b").tarjetablanca.p-4
                  .row.justify-content-center.align-items-center
                    .col-md-10.mb-4.mb-md-0.col-lg-6
                      h5.h5color Actitud pasiva
                      p La persona asume una actitud pasiva en el momento en que calla ante el maltrato que recibe, se suma a otra tesis, así no esté de acuerdo, no cree en sus conocimientos o no le es fiel a estos, se deja llevar por lo que digan los demás, le condiciona la baja autoestima, siendo esta una de las barreras más comunes en los procesos de comunicación.
                    .col-md-6.col-lg-4
                      figure
                        img(src='@/assets/curso/Tema1/img12.png', alt='')
                  .row.justify-content-center.align-items-center
                    .col-md-10.mb-4.mb-md-0.col-lg-6
                      h5.h5color Actitud agresiva
                      p Se asume una actitud agresiva, cuando la persona desde su cultura, su crianza y la forma de percibir al otro, piensa la violencia como recurso para solucionar problemas o sortear situaciones que estime van en contra de su lógica, dado que se aferra tanto a esta que desconoce otras formas de pensar.
                    .col-md-6.col-lg-4
                      figure
